...
<!--      </el-col>-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="诊断标签" prop="diagnosisLabel">
          <el-input v-model="form.diagnosisLabel" placeholder="请输入诊断标签" />
        </el-form-item>
        <el-form-item label="创建人" prop="createUser">
...
<script>
import { listLabel, getLabel, delLabel, addLabel, updateLabel } from "@/api/rud/rule/rulelabel/label";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除疾病（诊断）标签编号为"' + ids + '"的数据项?', "警告", {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('lkai-rud/label/export', {
        ...this.queryParams
      }, `rud_label.xlsx`)
    }
  }
